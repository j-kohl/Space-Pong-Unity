		...
		//  Debug.Log(other.gameObject.tag);
			switch(other.gameObject.tag){		
				...
				case "ShieldCollectible":
					GameController.Instance.ShieldCollectibleHit(lastPlayerHit);
					break;	
				case "LaserCollectible":
					GameController.Instance.LaserCollectibleHit(lastPlayerHit);
					break;	
				case "MissileCollectible":
					GameController.Instance.MissileCollectibleHit(lastPlayerHit);
					break;	
				/*case "Top Border":
